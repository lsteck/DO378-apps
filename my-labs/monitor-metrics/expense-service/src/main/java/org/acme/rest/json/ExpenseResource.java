...
public class ExpenseResource {
    ...
    @Counted(
        ...
        description = "How many requessts to list expenses have happened."
    )
    @Timed(
        name = "expenseListTimer",
        description = "How long it takes to list expensess.",
    ...
    @Counted(
        ...
        description = "How many requests have attenpted creating an expense object"
    )
    @Timed(
        name = "expenseCreateTimer",
        description = "How long it takes to create an expenseobject",
        unit = MetricUnits.MILLISECONDS
    )
    @Transactional
